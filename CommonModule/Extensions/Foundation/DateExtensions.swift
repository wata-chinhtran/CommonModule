...
extension DateFormatter {
    ...
    @nonobjc static let serverDate_format: DateFormatter = {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ssZZZZ"
        return dateFormatter
    }()
    
    @nonobjc static let serverDate_millisec_format: DateFormatter = {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZZZZ"
        return dateFormatter
    }()
    
    @nonobjc static let prettyMonth_format: DateFormatter = {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "MMMM, yyyy"
        return dateFormatter
    }()
    
    @nonobjc static let ddMMyy_format: DateFormatter = {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd/MM/yy"
        return dateFormatter
    }()
    
    @nonobjc static let ddMM_format: DateFormatter = {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd/MM"
        return dateFormatter
    }()
    
    @nonobjc static let ddMMyyyy_server_format: DateFormatter = {
        let dateFormatter = DateFormatter()
...
extension Date {
    ...
    /// Convert to string with given defined format.
    ///
    /// - Parameter format: DateFormatter object.
    /// - Returns: Converted string.
    func string(with format: DateFormatter) -> String {
        return format.string(from: self).replacingOccurrences(of: "GMT", with: "")
    }
}

extension String {
    
    /// Convert to date with given defined format.
    ///
    /// - Parameter format: DateFormatter object.
